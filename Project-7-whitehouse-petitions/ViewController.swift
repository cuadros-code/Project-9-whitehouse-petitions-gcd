...
//        }
//        
//        // [ IMPORTANT ] All code inside the closure also work in the Background Thread
//        // in this case [ parce(json: data), showError() ]
...
//    func showError() {
//        
//        // Como back to main thread in the interface update
